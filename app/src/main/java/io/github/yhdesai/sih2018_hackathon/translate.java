...
public class translate {
    ...
    public static void detectLanguage(String sourceText, PrintStream out) {
        ...
        out.println("Language(s) detected:");
    ...
    public static void translateTextWithOptions(
        ...
        TextView txtSpeechOutput = (TextView) ((MainActivity)context).findViewById(R.id.text);
        Translate translate = createTranslateService();
        TranslateOption srcLang = TranslateOption.sourceLanguage(sourceLang);
        TranslateOption tgtLang = TranslateOption.targetLanguage(targetLang);
     ...
     */
    public static void displaySupportedLanguages(PrintStream out, String tgtLang) {
        Translate translate = createTranslateService();
    ...
    public static void main(String[] args) {
        ...
        if (command.equals("detect")) {
            text = args[1];
            translate.detectLanguage(text, out);
            ...
            try {
                ...
                translate.translateText(text, out);
            }
